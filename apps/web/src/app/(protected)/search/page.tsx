            ...
            >
              ...
              >
                ...
                >
                  ...
                  /* Mode Sombre : visibilité et contraste maxima */
                  .dark .illustration-light,
                  html.dark .illustration-light,
                  [data-theme='dark'] .illustration-light {
                    display: none !important;
                  }
                  .dark .illustration-dark,
                  html.dark .illustration-dark,
                  [data-theme='dark'] .illustration-dark {
                    display: block !important;
                    animation: floatSubtle 6s infinite ease-in-out !important;
                    mix-blend-mode: normal !important;
                    filter: invert(0.95) hue-rotate(160deg) brightness(2.2) contrast(1.25) drop-shadow(0 0 20px rgba(74, 222, 128, 0.45)) !important;
                    opacity: 1 !important;
                  }
                  .dark .desktop-illustration,
                  html.dark .desktop-illustration,
                  [data-theme='dark'] .desktop-illustration {
                    background: radial-gradient(50% 50% at 50% 50%, rgba(34, 197, 94, 0.22) 0%, transparent 100%) !important;
                  }
