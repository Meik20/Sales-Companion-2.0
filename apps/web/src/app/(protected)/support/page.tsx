    ...
    <AppShell>
      ...
      >
        ...
        >
          {showNew ? (
            <>
              <X size={14} /> {t('support.cancel')}
            </>
          ) : (
            <>
              <Plus size={14} /> {t('support.newConversation')}
            </>
          )}
        </button>
      </div>
      ...
      <div className="sup-layout">
        ...
        >
          ...
          >
            <span>
              {t('support.conversationsList')} ({threads.length})
            </span>
            ...
            <>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <style
                    dangerouslySetInnerHTML={{
                      __html: `@media(max-width:768px){.mob-back{display:flex!important;}}`
                    }}
                  />
                  <div>
                ...
                >
                  {getStatusLabel(selectedThread?.status ?? 'open', t)}
                </span>
              </div>
              ...
              >
                {messages.length === 0 ? (
                  ...
                  >
                    <MessageSquare
                      size={32}
                      style={{ opacity: 0.25, margin: '0 auto 10px', display: 'block' }}
                    />
                  ...
                  messages.map((m) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={isMe ? 'msg-user' : 'msg-admin'}
                          style={{
                            maxWidth: '75%',
                            padding: '10px 14px',
                            fontSize: 13.5,
