    ...
    <div
      ...
      className={`w-full z-50 transition-all duration-300 px-4 py-2 text-sm flex items-center justify-between shadow-md ${
        !isOnline
          ...
          : 'bg-emerald-600 text-white dark:bg-emerald-700 animate-in fade-in slide-in-from-top-2'
      }`}
    >
      ...
      {isOnline && wasOffline && (
        <button
          ...
          aria-label="Fermer"
          className="p-1 rounded hover:bg-emerald-700/50 text-emerald-100 transition-colors"
        >
          <X className="h-4 w-4" />
        </button>
      )}
