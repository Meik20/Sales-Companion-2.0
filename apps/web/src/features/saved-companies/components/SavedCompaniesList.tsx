        ...
        return (
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 200 }}>
              <div style={{ fontWeight: 800, fontSize: 16, color: colors.text, marginBottom: 6, display: 'flex', alignItems: 'center', gap: 8 }}>
                {item.companyName}
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
                {city && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4, color: colors.textMid, fontSize: 13 }}>
