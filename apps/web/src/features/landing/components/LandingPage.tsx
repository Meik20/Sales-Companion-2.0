...
export function LandingPage() {
  ...
  useEffect(() => {
    ...
    // Générer le QR Code via le proxy d'API local sécurisé
    const appUrl = window.location.protocol + '//' + window.location.host + '/search'
    setQrCodeUrl('/api/qr?data=' + encodeURIComponent(appUrl))
          ...
          <div className="nav-desktop" id="nav-desktop">
            ...
            <div className="nav-cta">
              ...
              <a
                href="/login"
                className="btn btn-ghost btn-sm"
                title="Se connecter à votre espace prospection"
              >
                {t('landing.login')}
              </a>
              <a
     ...
     ═══════════════════════════════════════════════════  */}
      <section className="hero" id="hero">
        ...
        <h1 className="hero-title">
          ...
          <br />
          {t('landing.heroTitle2')} <em>{t('landing.heroTitle3')}</em>
        ...
        <div className="hero-actions">
          <a
            ...
            title="Commencer la prospection B2B au Cameroun"
          >
            {t('landing.startFree')}
          </a>
          <a
            ...
            title="Découvrir l'annuaire et le CRM"
          >
          ...
          <div className="mockup">
            <div className="mockup-bar">
              ...
              <div className="mockup-notch">
                <div className="mockup-notch-dot"></div>
              </div>
              <span>●●●</span>
            </div>
            <div className="mockup-screen">
              ...
              {/*  Pipeline mini  */}
              <div
                className="mockup-result"
                style={{ background: 'rgba(27,122,62,0.08)', borderColor: 'rgba(27,122,62,0.2)' }}
              >
                <div className="mockup-pip-bar">
                  <div>
                    <div className="mockup-result-name" style={{ color: 'var(--gm)' }}>
                      Pipeline
                    </div>
                    <div className="mockup-result-meta">
                      <span>3 prospects actifs</span>
                    </div>
                  </div>
        ...
        <div className="pwa-install-banner" id="pwa-install-banner">
          ...
          <div className="pwa-install-content">
            ...
            <p className="pwa-install-desc">{t('landing.pwaBanner.desc')}</p>
            <div className="pwa-install-actions">
              <button
                id="install-pwa-btn-banner"
                className="btn-install-pwa hidden"
                aria-label={t('landing.pwaBanner.installAria')}
              >
        ...
        <div className="container">
          <header className="section-header reveal">
            ...
            <h2 className="section-title" id="features-title">
              {t('landing.featuresSection.title1')}
              <br />
              {t('landing.featuresSection.title2')} <em>{t('landing.featuresSection.title3')}</em>
            </h2>
            <p className="section-sub">{t('landing.featuresSection.sub')}</p>
          </header>
          ...
          <div className="features-grid" role="list">
            <article className="feature-card reveal" role="listitem">
              ...
              <p className="feature-desc">{t('landing.featuresSection.f1Desc')}</p>
            ...
            <article className="feature-card reveal reveal-d1" role="listitem">
              ...
              <p className="feature-desc">{t('landing.featuresSection.f2Desc')}</p>
            ...
            <article className="feature-card reveal reveal-d2" role="listitem">
              ...
              <p className="feature-desc">{t('landing.featuresSection.f3Desc')}</p>
            ...
            <article className="feature-card reveal" role="listitem">
              ...
              <p className="feature-desc">{t('landing.featuresSection.f4Desc')}</p>
            ...
            <article className="feature-card reveal reveal-d1" role="listitem">
              ...
              <p className="feature-desc">{t('landing.featuresSection.f5Desc')}</p>
            ...
            <article className="feature-card reveal reveal-d2" role="listitem">
              ...
              <p className="feature-desc">{t('landing.featuresSection.f6Desc')}</p>
        ...
        <div className="container">
          <header className="section-header reveal">
            ...
            <h2 className="section-title" id="roles-title">
              {t('landing.rolesSection.title1')} <em>{t('landing.rolesSection.title2')}</em>
              <br />
              {t('landing.rolesSection.title3')}
            </h2>
            <p className="section-sub">{t('landing.rolesSection.sub')}</p>
          </header>

          <div className="roles-grid">
            <article className="role-card reveal">
              <div
                className="role-card-accent"
                style={{ background: 'linear-gradient(90deg, #1B7A3E, #2ea05a)' }}
                aria-hidden="true"
              ></div>
              ...
              <p className="role-desc">{t('landing.rolesSection.indepDesc')}</p>
            ...
            <article className="role-card reveal reveal-d1">
              <div
                className="role-card-accent"
                style={{ background: 'linear-gradient(90deg, #F5A623, #c8841a)' }}
                aria-hidden="true"
              ></div>
              <span className="role-icon" aria-hidden="true">
                📋
              ...
              <p className="role-desc">{t('landing.rolesSection.mgrDesc')}</p>
              <ul className="role-perks" role="list">
                <li className="role-perk" role="listitem">
                  <span
                    className="role-perk-dot"
                    aria-hidden="true"
        ...
        <div className="container">
          <header className="section-header reveal">
            ...
            <h2 className="section-title" id="plans-title">
              {t('landing.plansSection.title1')} <em>{t('landing.plansSection.title2')}</em>
              <br />
              {t('landing.plansSection.title3')}
            </h2>
            <p className="section-sub">{t('landing.plansSection.sub')}</p>
          </header>
          ...
          <div className="plans-grid">
            ...
            <article className="plan-card reveal" aria-label="Plan Gratuit">
              ...
              <ul className="plan-features" role="list">
                ...
                <li className="plan-feature" role="listitem" style={{ opacity: 0.45 }}>
                  <span style={{ color: 'var(--tx3)' }} aria-hidden="true">
                    ✗
                  </span>
              ...
              <a
                ...
                aria-label="Démarrer avec le plan Gratuit"
              >
            ...
            <article className="plan-card reveal reveal-d05" aria-label="Plan Starter">
              ...
              <div className="plan-price">
                {t('landing.plansSection.starterPrice')} <sub>FCFA</sub>
              </div>
            ...
            {/*  Pro — featured  */}
            <article
              className="plan-card featured reveal reveal-d1"
              aria-label="Plan Pro — Recommandé"
            >
              <div className="plan-featured-label" aria-label="Plan recommandé">
                {t('landing.plansSection.recommended')}
              </div>
              ...
              <div className="plan-price">
                {t('landing.plansSection.proPrice')} <sub>FCFA</sub>
              </div>
              ...
              <a
                ...
                style={{ width: '100%', justifyContent: 'center' }}
                aria-label="Commencer avec le plan Pro"
              >
            ...
            <article className="plan-card reveal reveal-d2" aria-label="Plan Enterprise">
              ...
              <div className="plan-price">
                {t('landing.plansSection.enterprisePrice')} <sub>FCFA</sub>
              </div>
              ...
              <a
                ...
                style={{ width: '100%', justifyContent: 'center' }}
                aria-label="Démarrer avec le plan Enterprise"
              >
        ...
        <div className="container">
          <header className="section-header reveal">
            <h2 className="section-title" id="use-cases-title">
              {t('landing.useCasesSection.title1')} <em>{t('landing.useCasesSection.title2')}</em>{' '}
              {t('landing.useCasesSection.title3')}
            </h2>
            <p className="section-sub">{t('landing.useCasesSection.sub')}</p>
          </header>

          <div className="features-grid">
            <article
              className="feature-card reveal"
              aria-label={t('landing.useCasesSection.uc1Title')}
            >
              <div
            ...
            <article
              className="feature-card reveal reveal-d1"
              aria-label={t('landing.useCasesSection.uc2Title')}
            >
              <div
                className="feature-icon"
                aria-hidden="true"
            ...
            <article
              className="feature-card reveal reveal-d2"
              aria-label={t('landing.useCasesSection.uc3Title')}
            >
              <div
                className="feature-icon"
                aria-hidden="true"
        ...
        <div className="container">
          <header className="section-header reveal">
            <h2 className="section-title" id="faq-title">
              {t('landing.faqSection.title1')} <em>{t('landing.faqSection.title2')}</em>{' '}
              {t('landing.faqSection.title3')}
            </h2>
            <p className="section-sub">{t('landing.faqSection.sub')}</p>
          </header>
          ...
          >
            <article className="feature-card reveal" style={{ padding: '20px', textAlign: 'left' }}>
              <h3 style={{ fontSize: '18px', marginBottom: '8px', color: 'var(--tx)' }}>
                {t('landing.faqSection.q1')}
              </h3>
              <p style={{ color: 'var(--tx2)', fontSize: '15px', margin: 0 }}>
            ...
            <article
              className="feature-card reveal reveal-d3"
              style={{ padding: '20px', textAlign: 'left' }}
            >
              <h3 style={{ fontSize: '18px', marginBottom: '8px', color: 'var(--tx)' }}>
                {t('landing.faqSection.q4')}
              </h3>
              <p style={{ color: 'var(--tx2)', fontSize: '15px', margin: 0 }}>
        ...
        <div className="container">
          <header className="section-header reveal">
            ...
            <h2 className="section-title" id="testimonials-title">
              {t('landing.testiSection.title1')}
              <br />
              {t('landing.testiSection.title2')} <em>{t('landing.testiSection.title3')}</em>
            </h2>
          </header>
          ...
          <div className="testimonials-grid">
            ...
            <article
              className="testimonial-card reveal reveal-d1"
              aria-label="Témoignage de Marcelline K."
            >
              <div className="testimonial-stars" aria-label="5 étoiles sur 5">
                ★★★★★
              </div>
            ...
            <article
              className="testimonial-card reveal reveal-d2"
              aria-label="Témoignage de Pascal A."
            >
              <div className="testimonial-stars" aria-label="5 étoiles sur 5">
                ★★★★★
              </div>
        ...
        <div className="container">
          <header className="section-header reveal">
            ...
            <h2 className="section-title" id="privacy-title">
              ...
              <em>{t('landing.privacy.titleHighlight')}</em>
            </h2>
            <p className="section-sub">{t('landing.privacy.subtitle')}</p>
          </header>
          ...
          >
            ...
            >
              {[
                {
                  icon: '🔐',
                  title: t('landing.privacy.security.tls.title'),
                  desc: t('landing.privacy.security.tls.desc')
                },
                {
                  icon: '🏦',
                  title: t('landing.privacy.security.firebase.title'),
                  desc: t('landing.privacy.security.firebase.desc')
                },
                {
                  icon: '🚫',
                  title: t('landing.privacy.security.resale.title'),
                  desc: t('landing.privacy.security.resale.desc')
                },
                {
                  icon: '📍',
                  title: t('landing.privacy.security.hosting.title'),
                  desc: t('landing.privacy.security.hosting.desc')
                }
              ].map((item) => (
                <div
                  key={item.title}
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      style={{ fontSize: '13px', color: 'rgba(255,255,255,0.78)', lineHeight: 1.5 }}
                    >
                      {item.desc}
                    </div>
                  </div>
        ...
        <div className="container">
          <div className="cta-section reveal">
            ...
            <h2 className="cta-title" id="cta-title">
              {t('landing.ctaSection.title1')}
              <br />
              {t('landing.ctaSection.title2')} <em>{t('landing.ctaSection.title3')}</em>{' '}
              {t('landing.ctaSection.title4')}
            </h2>
            <p className="cta-sub">{t('landing.ctaSection.sub')}</p>
            <div
              style={{
                display: 'flex',
                alignItems: 'center',
            ...
            <div className="footer-cols">
              ...
              <nav className="footer-col" aria-label="Liens application">
                ...
                <ul role="list">
                  ...
                  <li>
                    <a href="/login">{t('landing.footer.search')}</a>
                  </li>
                  <li>
                    <a href="/login">{t('landing.footer.pipeline')}</a>
                  </li>
                </ul>
              </nav>
              <nav className="footer-col" aria-label="Liens support">
                ...
                <ul role="list">
                  <li>
                    <a href="/login">{t('landing.footer.assistance')}</a>
                  </li>
                  <li>
