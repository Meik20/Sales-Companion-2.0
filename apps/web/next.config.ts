        ...
        headers: [
          ...
          // Content-Security-Policy: restrict sources to self + Firebase
          {
            ...
            value: [
              ...
              `connect-src 'self' ${APP_URL} https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com https://region1.google-analytics.com https://*.firebaseio.com https://*.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com wss://*.firebaseio.com https://apis.google.com`,
